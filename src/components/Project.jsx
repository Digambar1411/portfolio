...
function Project({ project }) {
  return (
    <div className='min-h-32 p-4 hover:transition rounded-xl shadow-md flex justify-between gap-4 items-start border border-transparent dark:text-gray-100 dark:border-gray-500! hover:border hover:border-black'>
      <div>
